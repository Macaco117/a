<template>
  <input 
   ...
   <div class="form-check form-check inline">
     ...
     value="Node.js"
     >
     <label for="check-1" class="form-check-label">Node.js</label>
   </div>
   ...
   <div class="mt-2"> 
     <div class="form-check form-check inline">
       <input type="radio"
        ...
        >
       <label for="radio-1" class="form-check-label">Prioritario</label>
      </div>
      <div class="form-check form-check inline">
       <input type="radio"
        id="radio-2"
        ...
        v-model="tarea.estado"
        >
       <label for="radio-2" class="form-check-label">Normal</label>
      </div>
    </div>
    <div class="mt-2">
      <input type="number"
